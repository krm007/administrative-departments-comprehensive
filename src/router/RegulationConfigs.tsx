...
const RegulationConfigs: RouteConfig[] = [
    ...
    },
    {
        ...
        component: () => (
            <BocoTable
                title={"医生工作站质控管理"}
                tableTitle={VirtualTableTitleConfig.get("yishenggongzuozhanzhikongguanli")}
            />
        )
    }, {
        ...
        component: () => (
            <BocoTable
                title={"临床实验室质控管理"}
                tableTitle={VirtualTableTitleConfig.get("linchuangshiyanshizhikongguanli")}
            />
        )
    }, {
        ...
        component: () => (
            <BocoTable
                title={"远程影像质控管理"}
                tableTitle={VirtualTableTitleConfig.get("yuanchengyingxiangzhikongguanli")}
            />
        )
    }, {
    ...
    },
    {
        ...
        component: () => <BocoTable title={"科室领用分析"} tableTitle={VirtualTableTitleConfig.get("keshilingyongfenxi")}/>
    },
    {
        path:
            "/administrativeDepartment/generalAffairsManagement/warehouseInventory",
        component: () => <BocoTable title={"库房库存分析"} tableTitle={VirtualTableTitleConfig.get("kufangkucunfenxi")}/>
    },
    {
        path: "/administrativeDepartment/generalAffairsManagement/equipmentList",
        component: () => <BocoTable title={"在用设备清单"} tableTitle={VirtualTableTitleConfig.get("zaiyongshebeiqingdan")}/>
    },
    {
    ...
    },
    {
        ...
        component: () => <BocoTable title={"报表管理统计查询"} tableTitle={VirtualTableTitleConfig.get("baobiaoguanlichaxun")}/>
    },
    /** ****************** */
    /** 全面质量管理（未做） */
    ...
    // },
    {
        ...
        component: () => <BocoTable title={"护理质量随访"} tableTitle={VirtualTableTitleConfig.get("hulibusuifang")}/>
    }, {
        path: "/totalQualityManage/huanzhechuyuansuifang/danbingzhongsuifang",
        component: () => <BocoTable title={"单病种随访"} tableTitle={VirtualTableTitleConfig.get("danbingzhongsuifang")}/>
    }, {
        path: "/totalQualityManage/huizongtongjibaobiaoguanli/tongjihuizongbaobiao",
        component: () => <BocoTable title={"统计汇总报表"} tableTitle={VirtualTableTitleConfig.get("tongjihuizongbaobiao")}/>
    },
    {
    ...
    },
    {
        ...
        component: () => <BocoTable title={"病人构成分析"} tableTitle={VirtualTableTitleConfig.get("bingrengouchengfenxi")}/>
    },
    {
    ...
    },
    {
        ...
        component: () => <BocoTable title={"病种分类统计"} tableTitle={VirtualTableTitleConfig.get("bingzhongfenleitongji")}/>
    },
    /** 质量控制管理（未做） */
    {
        path: "/qualityControlManage/yishenggongzuozhanzhikongguanli",
        component: () => <BocoTable title={"医生工作站质控管理"}
                                    tableTitle={VirtualTableTitleConfig.get("yishenggongzuozhanzhikongguanli")}/>
    }, {
        path: "/qualityControlManage/hulibuzhikongguanli",
        component: () => <BocoTable title={"护理部质控管理"} tableTitle={VirtualTableTitleConfig.get("hulibuzhikongguanli")}/>
    }, {
        path: "/qualityControlManage/linchuangshiyanshizhikongguanli",
        component: () => <BocoTable title={"临床实验室质控管理"}
                                    tableTitle={VirtualTableTitleConfig.get("linchuangshiyanshizhikongguanli")}/>
    }, {
        path: "/qualityControlManage/yuanchengyingxiangzhikongguanli",
        component: () => <BocoTable title={"远程影像质控管理"}
                                    tableTitle={VirtualTableTitleConfig.get("yuanchengyingxiangzhikongguanli")}/>
    }, {
        path: "/qualityControlManage/xindianzhikong",
        component: () => <BocoTable title={"心电质控"} tableTitle={VirtualTableTitleConfig.get("xindianzhikong")}/>
    },
    {
        path:  "/criticalValue/doctorWorkstation",
        component: () => <BocoTable title={"医生工作站危急值"} tableTitle={VirtualTableTitleConfig.get("yishenggongzuozhanweijizhi")}/>
    },
    {
        path:  "/criticalValue/nurseWorkstation",
        component: () => <BocoTable title={"护士工作站危急值"} tableTitle={VirtualTableTitleConfig.get("hushigongzuozhanweijizhi")}/>
    },
    {
