...
import {renderContent } from "./renderRule"
/**
 * 没有合并单元格table
 */
  ...
  [
    ...
    [
        ...
        [
            ...
            title: "区域影像检查总数:按日统计上传到中心平台且已进行影像检查的各医院申请单总数",
            align: "center",
            dataIndex: "qyyxJianChaZongShu",
            key: "qyyxJianChaZongShu",
        }, {
            title: "区域请求远程诊断总数:按日统计区域内各医院请求协助写报告的检查申请单总数",
            align: "center",
        ...
        [
            ...
            title: "报告数量:按日统计区域内各医院报告医师书写请求协助报告的数量，当日",
            align: "center",
        ...
        [
            ...
            title: "拍片数量:按日统计区域内每个医院各个影像设备类型（例如CT，MR…）的拍片数量，当日",
            align: "center",
