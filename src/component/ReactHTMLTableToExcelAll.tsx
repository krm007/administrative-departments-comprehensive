...
interface Iprops {
  ...
  className: string;
  buttonText: string;
  onRef:(Comment:any)=>void;
  onClick:(e:any)=>void
}
class ReactHTMLTableToExcelAll extends React.Component<Iprops> {
  ...
  public handleDownload() {
    ...
    element.href =
      uri +
      ReactHTMLTableToExcelAll.base64(
        ReactHTMLTableToExcelAll.format(template, context)
      );
...
export default ReactHTMLTableToExcelAll;
